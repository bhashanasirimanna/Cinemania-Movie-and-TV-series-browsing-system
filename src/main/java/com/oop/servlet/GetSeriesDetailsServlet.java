 ...
 */
public class GetSeriesDetailsServlet extends HttpServlet {
	 ...
	 */
	public GetSeriesDetailsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/SeriesPreviewShow.jsp");
