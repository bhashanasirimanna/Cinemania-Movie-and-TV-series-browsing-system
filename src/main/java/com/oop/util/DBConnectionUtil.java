...
public class DBConnectionUtil extends CommonUtil {
	 ...
	 * 
	 * @throws ClassNotFoundException - Thrown when an application tries to load in
	 *                                a class through its string name
	 * @throws SQLException           - An exception that provides information on a
	 *                                database access error or other errors
	 */
	public static Connection getDBConnection() throws ClassNotFoundException, SQLException {
		
		//WORKING!!! = System.out.println("Im from DBConnectionUtil.java");
		/*
		...
		if (connection == null || connection.isClosed()) {
			...
			//System.out.println("Im from DBConn -> getDBConn");
		}
		return connection;
	}
