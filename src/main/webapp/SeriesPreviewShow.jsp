			...
			<section class="movie-detail">
				<div class="container">
					...
					<figure class="movie-detail-banner">
						...
						<img src="seriesimages/<%=series.getPoster()%>" alt="Free guy movie poster">
					...
					<div class="movie-detail-content">
						...
						<p class="detail-subtitle">New TV Series</p>

						<h1 class="h1 detail-title">
							<%=series.getTitle()%>
						</h1>
						<p class="detail-subtitle" style="font-size: 15px;">Director: <font style="color: white;"><%=series.getDirector()%></font></p>
						...
						<div class="meta-wrapper">
							...
							<div class="date-time">
								...
								<div>
									...
									<time datetime="2021"><%=series.getReleaseYear()%></time>
								</div>

								<div>
									<ion-icon name="time-outline"></ion-icon>

									<time datetime="PT115M"><%=series.getRating()%> min</time>
								</div>

							</div>

						</div>
						<p class="detail-subtitle" style="font-size: 15px;">Seasons: <font style="color: white;"><%=series.getSeason()%></font></p>
						<p class="detail-subtitle" style="font-size: 15px;">Episodes: <font style="color: white;"><%=series.getEpisode()%></font></p>
						<p class="storyline"><%=series.getDescription()%></p>
